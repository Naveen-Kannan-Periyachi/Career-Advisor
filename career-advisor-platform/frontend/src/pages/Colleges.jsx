...
const Colleges = () => {
  ...
  // ...existing code...
  // Add missing states, streams, and filteredColleges logic
  ...
  const filteredColleges = colleges.filter(college => {
    ...
    const matchesStream = !selectedStream || college.courses.some(course => course.includes(selectedStream));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 animate-fadeIn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 animate-fadeInUp">Colleges</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredColleges.map(college => (
            <div key={college.id} className="glass rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-transform duration-300 hover:scale-105 animate-fadeInUp">
              <div className="p-6">
