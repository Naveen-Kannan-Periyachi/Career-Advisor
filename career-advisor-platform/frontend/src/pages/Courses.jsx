  ...
  const courses = [
    {
      ...
      level: 'Undergraduate',
      duration: 3,
      description: 'A foundational science degree covering Physics, Chemistry, Biology, and Mathematics.',
      subjects: ['Physics', 'Chemistry', 'Biology', 'Mathematics'],
      careerPaths: ['Research', 'Teaching', 'Lab Technician', 'Further Studies'],
      demand: 'High',
    ...
    },
    {
      ...
      level: 'Undergraduate',
      duration: 3,
      description: 'A degree focusing on humanities, languages, and social sciences.',
      subjects: ['History', 'Political Science', 'English', 'Economics'],
      careerPaths: ['Civil Services', 'Teaching', 'Content Writing', 'NGO'],
      demand: 'Medium',
      salaryRange: { min: 250000, max: 700000 }
    },
    {
      id: 3,
      ...
      level: 'Undergraduate',
      duration: 3,
      description: 'A commerce degree focusing on accounting, finance, and business studies.',
      subjects: ['Accounting', 'Finance', 'Business Studies', 'Economics'],
      careerPaths: ['Accountant', 'Banking', 'Finance Analyst', 'CA'],
      demand: 'High',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 animate-fadeIn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 animate-fadeInUp">Courses</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredCourses.map(course => (
            <div key={course.id} className="glass rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-transform duration-300 hover:scale-105 animate-fadeInUp">
              <div className="p-6">
