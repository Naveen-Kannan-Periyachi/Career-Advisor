...
const Assessment = () => {
  ...
  {/* Assessment Overview */}
  <div className="glass rounded-2xl shadow-xl p-8 mb-8 animate-fadeInUp">
  ...
  {/* Instructions */}
  <div className="bg-blue-50 rounded-lg p-6 mb-8 animate-fadeInUp">
        ...
        <div className="text-center">
          <button className="btn-animated bg-blue-600 text-white px-8 py-3 rounded-2xl font-semibold shadow-lg hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-blue-600 transition inline-flex items-center">
            Start Assessment
  ...
  {/* Previous Results */}
  <div className="mt-12 glass rounded-2xl shadow-xl p-8 animate-fadeInUp">
